...
namespace projektV2
{
    ...
    public partial class RegisterForm : Form
    {
        ...
        /// </summary>
        /// <param name="pass1">password 1</param>
        /// <param name="pass2">password 2</param>
        ...
        /// <param name="e">taking event</param>
        ...
        /// <summary>
        /// if user want to change view for login then change
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">taking event param</param>
